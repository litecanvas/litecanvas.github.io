(() => {
    ...
    function litecanvas(settings = {}) {
      ...
      const instance = {
        ...
        lerp: (start, end, t) => {
          DEV: assert(
            isNumber(start),
            "[litecanvas] lerp() 1st param must be a number"
          );
          DEV: assert(
            isNumber(end),
            "[litecanvas] lerp() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(t),
            "[litecanvas] lerp() 3rd param must be a number"
          );
        ...
        round: (n, precision = 0) => {
          DEV: assert(
            isNumber(n),
            "[litecanvas] round() 1st param must be a number"
          );
          DEV: assert(
        ...
        clamp: (value, min, max) => {
          DEV: assert(
            isNumber(value),
            "[litecanvas] clamp() 1st param must be a number"
          );
          DEV: assert(
            isNumber(min),
            "[litecanvas] clamp() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(max),
            "[litecanvas] clamp() 3rd param must be a number"
          );
          DEV: assert(
            max > min,
        ...
        wrap: (value, min, max) => {
          DEV: assert(
            isNumber(value),
            "[litecanvas] wrap() 1st param must be a number"
          );
          DEV: assert(
            isNumber(min),
            "[litecanvas] wrap() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(max),
            "[litecanvas] wrap() 3rd param must be a number"
          );
          DEV: assert(
            max > min,
        ...
        map(value, start1, stop1, start2, stop2, withinBounds) {
          DEV: assert(
            isNumber(value),
            "[litecanvas] map() 1st param must be a number"
          );
          DEV: assert(
            isNumber(start1),
            "[litecanvas] map() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(stop1),
            "[litecanvas] map() 3rd param must be a number"
          );
          DEV: assert(
            isNumber(start2),
            "[litecanvas] map() 4th param must be a number"
          );
          DEV: assert(
            isNumber(stop2),
            "[litecanvas] map() 5th param must be a number"
          );
          DEV: assert(
            stop1 !== start1,
        ...
        norm: (value, start, stop) => {
          DEV: assert(
            isNumber(value),
            "[litecanvas] norm() 1st param must be a number"
          );
          DEV: assert(
            isNumber(start),
            "[litecanvas] norm() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(stop),
            "[litecanvas] norm() 3rd param must be a number"
          );
          DEV: assert(
            start !== stop,
        ...
        wave: (from, to, t, fn = Math.sin) => {
          ...
          DEV: assert(
            isNumber(t),
            "[litecanvas] wave() 3rd param must be a number"
          );
          DEV: assert(
            "function" === typeof fn,
        ...
        rand: (min = 0, max = 1) => {
          DEV: assert(
            isNumber(min),
            "[litecanvas] rand() 1st param must be a number"
          );
          DEV: assert(
            isNumber(max),
            "[litecanvas] rand() 2nd param must be a number"
          );
          DEV: assert(
            max > min,
        ...
        randi: (min = 0, max = 1) => {
          DEV: assert(
            isNumber(min),
            "[litecanvas] randi() 1st param must be a number"
          );
          DEV: assert(
            isNumber(max),
            "[litecanvas] randi() 2nd param must be a number"
          );
          DEV: assert(
            max > min,
        ...
        rect(x, y, width, height, color, radii) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] rect() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] rect() 2nd param must be a number"
          );
          DEV: assert(
        ...
        rectfill(x, y, width, height, color, radii) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] rectfill() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] rectfill() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(width) && width >= 0,
        ...
        circ(x, y, radius, color) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] circ() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] circ() 2nd param must be a number"
          );
          DEV: assert(
        ...
        circfill(x, y, radius, color) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] circfill() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] circfill() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(radius) && radius >= 0,
        ...
        oval(x, y, radiusX, radiusY, color) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] oval() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] oval() 2nd param must be a number"
          );
          DEV: assert(
        ...
        ovalfill(x, y, radiusX, radiusY, color) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] ovalfill() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] ovalfill() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(radiusX) && radiusX >= 0,
        ...
        line(x1, y1, x2, y2, color) {
          DEV: assert(
            isNumber(x1),
            "[litecanvas] line() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y1),
            "[litecanvas] line() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(x2),
        ...
        linedash(segments, offset = 0) {
          ...
          DEV: assert(
            isNumber(offset),
            "[litecanvas] linedash() 2nd param must be a number"
          );
        ...
        text(x, y, message, color = 3, fontStyle = "normal") {
          DEV: assert(
            isNumber(x),
            "[litecanvas] text() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] text() 2nd param must be a number"
          );
          DEV: assert(
            null == color || (isNumber(color) && color >= 0),
        ...
        textsize(size) {
          DEV: assert(
            isNumber(size),
            "[litecanvas] textsize() 1st param must be a number"
          );
          _fontSize = size;
        },
        /**
        ...
        image(x, y, source) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] image() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] image() 2nd param must be a number"
          );
        ...
        translate(x, y) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] translate() 1st param must be a number"
          );
          DEV: assert(
            isNumber(y),
            "[litecanvas] translate() 2nd param must be a number"
          );
          _ctx.translate(~~x, ~~y);
        },
        /**
        ...
        scale(x, y) {
          DEV: assert(
            isNumber(x),
            "[litecanvas] scale() 1st param must be a number"
          );
          DEV: assert(
            null == y || isNumber(y),
            "[litecanvas] scale() 2nd param must be a number"
          );
          _ctx.scale(x, y || x);
        },
        /**
        ...
        rotate(radians) {
          DEV: assert(
            isNumber(radians),
            "[litecanvas] rotate() 1st param must be a number"
          );
          _ctx.rotate(radians);
        },
        /**
        ...
        alpha(value) {
          DEV: assert(
            isNumber(value),
            "[litecanvas] alpha() 1st param must be a number"
          );
        ...
        sfx(zzfxParams, pitchSlide = 0, volumeFactor = 1) {
          ...
          DEV: assert(
            isNumber(pitchSlide),
            "[litecanvas] sfx() 2nd param must be a number"
          );
          DEV: assert(
            isNumber(volumeFactor),
            "[litecanvas] sfx() 3rd param must be a number"
          );
          if (
            !root.zzfxV ||
        ...
        listen(eventName, callback) {
          ...
          _eventListeners[eventName] =
            _eventListeners[eventName] || /* @__PURE__ */ new Set();
          _eventListeners[eventName].add(callback);
          return () =>
            _eventListeners && _eventListeners[eventName].delete(callback);
        },
        /**
        ...
        def(key, value) {
          DEV: assert(
            "string" === typeof key,
            "[litecanvas] def() 1st param must be a string"
          );
          DEV: if (null == value) {
            console.warn(
  ...
  (() => {
    ...
    globalThis.utils.global = (e = true) => {
      for (let t in globalThis.utils)
        t !== "global" &&
          (e || globalThis[t] === void 0) &&
          (globalThis[t] = globalThis.utils[t]);
    };
    var Z = {};
    Pt(Z, {
      ANCHOR_BOT_LEFT: () => vt,
    ...
    var y = class {
      ...
      constructor(t = null, s = 0, r = 0, i = null, o = null) {
        (this._engine = t || globalThis),
          (this.ox = s),
          (this.oy = r),
          this.resize(i || this._engine.W - s, o || this._engine.H - r),
          (this.x = this.width / 2),
          (this.y = this.height / 2),
          (this._shake = { x: 0, y: 0, removeListener: null });
      }
      resize(t, s) {
        (this.width = t),
          (this.height = s),
      ...
      start(t = false) {
        ...
        let s = this.ox + this.width / 2,
          r = this.oy + this.height / 2;
        this._engine.translate(s, r),
          this._engine.scale(this.scale),
          this._engine.rotate(this.rotation),
          this._engine.translate(
            -this.x + this._shake.x,
            -this.y + this._shake.y
          );
      }
      end() {
        this._engine.pop();
      ...
      getWorldPoint(t, s, r = {}) {
        let i = Math.cos(-this.rotation),
          o = Math.sin(-this.rotation);
        return (
          (t = (t - this.width / 2 - this.ox) / this.scale),
          (s = (s - this.height / 2 - this.oy) / this.scale),
          (r.x = i * t - o * s + this.x),
          (r.y = o * t + i * s + this.y),
          r
        );
      ...
      getCameraPoint(t, s, r = {}) {
        ...
        return (
          ...
          (t = i * t - o * s),
          (s = o * t + i * s),
          (r.x = t * this.scale + this.width / 2 + this.ox),
          (r.y = s * this.scale + this.height / 2 + this.oy),
          r
        );
      }
      getBounds() {
      ...
      shake(t = 1, s = 0.3) {
        this.shaking ||
          (this._shake.removeListener = this._engine.listen("update", (r) => {
            (this._shake.x = this._engine.randi(-t, t)),
              (this._shake.y = this._engine.randi(-t, t)),
              (s -= r),
              s <= 0 && this.unshake();
          }));
      }
    ...
    var M = (e, t, s, r, i, o, a, n) => {
      let c = Math.max(e, i),
        x = Math.min(e + s, i + a) - c,
        p = Math.max(t, o),
        d = Math.min(t + r, o + n) - p;
      return [c, p, x, d];
    };
    var H = (e, t, s, r, i, o, a, n) => {
      let [c, x, p, d] = M(e, t, s, r, i, o, a, n),
        _ = "",
        g = e,
        l = t;
      return (
    ...
    var W = (e, t, s, r, i, o, a, n) =>
      e < i + a && e + s > i && t < o + n && t + r > o;
    var X = (e, t, s, r, i, o) =>
      (r - e) * (r - e) + (i - t) * (i - t) <= (s + o) * (s + o);
    var w = class e {
        _w;
        _h;
        _c;
        constructor(t, s, r = []) {
          (this._w = Math.max(1, ~~t)),
            (this._h = Math.max(1, ~~s)),
            (this._c = r);
        }
        [Symbol.iterator]() {
          let t = 0;
          return {
            next: () => ({
              value: [
                this.indexToPointX(t),
                this.indexToPointY(t),
                this._c[t++],
              ],
              done: t > this._c.length,
            }),
          };
        }
        clone() {
        ...
        forEach(t, s = false) {
          let r = s ? this.length - 1 : 0,
            i = s ? -1 : this.length,
            o = s ? -1 : 1;
          for (; r !== i; ) {
            let a = this.indexToPointX(r),
              n = this.indexToPointY(r),
              c = this._c[r];
...
`)
    ...
    var V = Math.cos,
      ...
      m = (e) => e instanceof I,
      h = (e = 0, t = e) => (m(e) && ((t = e.y), (e = e.x)), new I(e, t)),
      q = (e, t, s = t) => (m(t) ? q(e, t.x, t.y) : ((e.x = t), (e.y = s)), e),
      N = (e, t, s = t) =>
        m(t) ? N(e, t.x, t.y) : ((e.x += t), (e.y += s), e),
      A = (e, t, s = t) =>
        m(t) ? A(e, t.x, t.y) : ((e.x -= t), (e.y -= s), e),
      b = (e, t, s = t) =>
        m(t) ? b(e, t.x, t.y) : ((e.x *= t), (e.y *= s), e),
      L = (e, t, s = t) =>
        m(t) ? L(e, t.x, t.y) : ((e.x /= t || 1), (e.y /= s || 1), e),
      Tt = (e, t) => {
        let s = V(t),
          r = j(t);
      ...
      z = (e, t) => (k(e), b(e, t), e),
      K = (e) => Math.hypot(e.x, e.y),
      $ = (e) => e.x * e.x + e.y * e.y,
      k = (e) => {
        let t = K(e);
        return t > 0 && L(e, t), e;
      },
      At = (e, t = 1) => ($(e) > t * t && z(e, t), e),
      Lt = (e, t) => Math.hypot(t.x - e.x, t.y - e.y),
      kt = (e, t) => {
        let s = e.x - t.x,
          r = e.y - t.y;
        return s * s + r * r;
      },
      G = (e) => Math.atan2(e.y, e.x),
      St = (e) => G(e),
      Ot = (e, t) => Math.atan2(t.y - e.y, t.x - e.x),
      J = (e, t) => e.x * t.x + e.y * t.y,
      Ft = (e, t) => e.x * t.y - e.y * t.x,
      Ct = (e, t, s) => (
        (e.x += (t.x - e.x) * s || 0), (e.y += (t.y - e.y) * s || 0), e
      ),
      Bt = (e) => ((e.x = Math.abs(e.x)), (e.y = Math.abs(e.y)), e),
      Yt = (e) => ((e.x = Math.ceil(e.x)), (e.y = Math.ceil(e.y)), e),
      Zt = (e) => ((e.x = Math.floor(e.x)), (e.y = Math.floor(e.y)), e),
      Ut = (e) => ((e.x = Math.round(e.x)), (e.y = Math.round(e.y)), e),
      Ht = (e, t, s) => (
        e.x < t.x && (e.x = t.x),
        e.x > s.x && (e.x = s.x),
        e.y < t.y && (e.y = t.y),
      ...
      Wt = (e, t) => ((e.x %= t), (e.y %= t), e),
      Xt = (e, t, s = 1) => N(e, t.x * s, t.y * s),
      S = (e, t, s = t) => (m(t) ? S(e, t.x, t.y) : e.x === t && e.y === s),
      Dt = (e) => S(e, Q),
      Vt = (e) => [e.x, e.y],
      jt = (e = 1, t = e, s = globalThis.rand || Math.random) => {
        let r = s() * Rt,
          i = s() * (t - e) + e;
    ...
    var Jt = h(0.5, 0.5),
      ...
      O = class {
        ...
        hidden = false;
        constructor(t, s, r = v) {
          (this.sprite = t || { width: 0, height: 0 }),
            (this.pos = s || h(0)),
            (this._o = h(r)),
            (this._s = h(1, 1));
        }
        ...
        getBounds(t = true) {
          let s = this.sprite.width * (t ? this._s.x : 1),
            r = this.sprite.height * (t ? this._s.y : 1),
            i = this.pos.x - s * this.anchor.x,
            o = this.pos.y - r * this.anchor.y;
          return [i, o, s, r];
        }
        ...
        drawImage(t, s = true) {
          let r = this.anchor,
            i = -this.sprite.width * (this.flipX ? 1 - r.x : r.x),
            o = -this.sprite.height * (this.flipY ? 1 - r.y : r.y);
    ...
    var R = Math.PI / 2,
      ee = (e, t, s, r = 1, i = lt) => new F(e, t, s, r, i),
      lt = (e) => e,
      se = (e) => e * e,
      re = (e) => -e * (e - 2),
      ie = (e) => (e < 0.5 ? 2 * e * e : -2 * e * e + 4 * e - 1),
      oe = (e) => e * e * e - e * Math.sin(e * Math.PI),
      he = (e) => {
        let t = 1 - e;
      ...
      ne = (e) => Math.sin(13 * R * e) * Math.pow(2, 10 * (e - 1)),
      ce = (e) => Math.sin(-13 * R * (e + 1)) * Math.pow(2, -10 * e) + 1,
      le = (e) => {
        if (e < 0.5) {
          let r = Math.sin(13 * R * (2 * e)),
            i = Math.pow(2, 10 * (2 * e - 1));
          return 0.5 * r * i;
        }
        let t = Math.sin(-13 * R * (2 * e - 1 + 1)),
          s = Math.pow(2, -10 * (2 * e - 1));
        return 0.5 * (t * s + 2);
      },
      pt = (e) => 1 - C(1 - e),
      C = (e) =>
        e < 4 / 11
          ? (121 * e * e) / 16
          : e < 8 / 11
          ? (363 / 40) * e * e - (99 / 10) * e + 17 / 5
          : e < 9 / 10
          ? (4356 / 361) * e * e - (35442 / 1805) * e + 16061 / 1805
          : (54 / 5) * e * e - (513 / 25) * e + 268 / 25,
      pe = (e) => (e < 0.5 ? 0.5 * pt(e * 2) : 0.5 * C(e * 2 - 1) + 0.5),
      F = class {
        running = false;
        _o;
        _p;
        ...
        start(t) {
          ...
          this._cu.stop(false),
            ...
            (this.running = true);
          let s = this._o[this._p] || 0,
            r = this._rel ? s + this._x : this._x;
          return (
            (this._lc = this._lc || t || globalThis),
            (this._u = this._lc.listen("update", (i) => {
              if (this._t <= this._w) {
                this._t += i;
                return;
              }
              let o = this._t - this._w;
              (this._o[this._p] = this._lc.lerp(s, r, this._e(o / this._d))),
                (this._t += i),
                o >= this._d && ((this._o[this._p] = r), this.stop());
            })),
            this
          );
        }
        stop(t = true) {
          ...
          if (((this.running = false), this._u(), (this._t = 0), t))
            for (let s of this._cb) s(this._o);
          return this;
        }
        ...
        get progress() {
          return this.running && this._t > this._w
            ? (this._t - this._w) / this._d
            : 0;
        }
      };
    var B = (e) => 0.5 * (1 - Math.cos(e * Math.PI)),
      Y = class {
        _p = [];
        _po = 4;
        _pf = 0.5;
        ...
        noise(t, s = 0, r = 0) {
          ...
          for (let U = 0; U < this._po; U++) {
            ...
            (p = B(n)),
              (d = B(c)),
              (l = this._p[f & 4095]),
              (l += p * (this._p[(f + 1) & 4095] - l)),
              (u = this._p[(f + 16) & 4095]),
              (u += p * (this._p[(f + 16 + 1) & 4095] - u)),
              (l += d * (u - l)),
              (f += 256),
              (u = this._p[f & 4095]),
              (u += p * (this._p[(f + 1) & 4095] - u)),
              (E = this._p[(f + 16) & 4095]),
              (E += p * (this._p[(f + 16 + 1) & 4095] - E)),
              (u += d * (E - u)),
              (l += B(x) * (u - l)),
              (_ += l * g),
              (g *= this._pf),
    ...
    var ut = (e, t = true, s = false, r = globalThis) =>
      r.paint(e.width, e.height, (i) => {
        r.push(),
          r.scale(t ? -1 : 1, s ? -1 : 1),
          r.image(t ? -e.width : 0, s ? -e.height : 0, e),
          r.pop();
      });
    var ft = (e, t, s = true, r = globalThis) =>
      r.paint(e.width * t, e.height * t, (i) => {
        r.push(),
          (i.imageSmoothingEnabled = !s),
          r.scale(t),
          r.image(0, 0, e),
          r.pop();
      });
    var _t = (e, t, s = 1, r = globalThis) =>
      r.paint(e.width, e.height, (i) => {
        r.push(),
          r.alpha(s),
          r.rectfill(0, 0, e.width, e.height, t),
    ...
    var xt = (
      e,
      t,
      { borderWidth: s = 0, borderColor: r = 0, engine: i = globalThis } = {}
    ) => {
      let o = e * 2 + s;
      return i.paint(o, o, () => {
    ...
    var dt = (
      ...
      t,
      s,
      { borderWidth: r = 0, borderColor: i = 0, engine: o = globalThis } = {}
    ) => {
      let a = e + r * 2,
        n = t + r * 2;
      return o.paint(a, n, () => {
    ...
    var mt = (e, t = 0, s = 1) =>
      [...new Array(e).keys()].map((r) => t + s * r);
    var gt = (e, t = globalThis.rand || Math.random) => {
      e = [...e];
      for (let s = e.length - 1; s > 0; s--) {
        let r = Math.floor(t() * (s + 1)),
          i = e[s];
        (e[s] = e[r]), (e[r] = i);
      }
      return e;
  ...
  (() => {
    ...
    function y(t, e = {}) {
      return (
        (e = Object.assign({}, h, e)),
        l(t, 0),
        t.def("ASSETS", t.ASSETS || {}),
        (t.ASSETS.font = {}),
        {
          loadFont: async (r, a, p) => {
            let { baseURL: m, ignoreErrors: f } = e,
              o = c(a);
            a = b(a, m);
            let n = new FontFace(r, `url(${a})`),
              u = { asset: n, type: "font", fontName: r, src: a, id: o };
            ...
            return (
              s
                ...
                .catch((d) => {
                  if ((console.error(d), !f))
                    throw new Error("Failed to load font from " + a);
    ...
    function A(t, e = {}) {
      return (
        ...
        {
          loadImage: async (r, a) => {
            let { baseURL: p, ignoreErrors: m, crossOrigin: f } = e,
              o = t.stat(5),
              n = { splitFrames: F, convertColors: j(o) },
              u = c(r);
            r = b(r, p);
            let s = new Image(),
              d = { asset: s, type: "image", src: r, id: u };
    ...
    function F(t, e, i, r = 0, a = 0) {
      let p = [],
        m = Math.floor((t.width + a) / (e + a)),
        f = Math.floor((t.height + a) / (i + a));
      for (let o = 0; o < f; o++)
        for (let n = 0; n < m; n++) {
    ...
    function j(t) {
      return (e, i = false) => {
        let r = new OffscreenCanvas(e.width, e.height),
          a = r.getContext("2d");
        a.drawImage(e, 0, 0);
        let p = a.getImageData(0, 0, e.width, e.height),
          m = p.data,
          f = /* @__PURE__ */ new Map();
    ...
    function P(t, e) {
      ...
      return (
        e.forEach((f) => {
          let [o, n, u] = f.startsWith("#") ? O(f) : D(f),
            s = Math.sqrt((a - o) ** 2 + (p - n) ** 2 + (m - u) ** 2);
          s < i && ((i = s), (r = f));
        }),
        r
      );
    ...
    function E(t, e = {}) {
      return (
        ...
        (t.ASSETS.script = {}),
        {
          loadScript: async (r, a) => {
            let { baseURL: p, ignoreErrors: m, crossOrigin: f } = e,
              o = c(r);
            r = b(r, p);
            let n = document.createElement("script"),
              u = { asset: n, type: "script", src: r, id: o };
            return new Promise((s) => {
              l(t, 1),
                (n.crossOrigin = f),
                (n.onerror = (d) => {
                  if ((console.error(d), !m))
        ...
        (t.ASSETS.sound = {}),
        {
          loadSound: async (r, a) => {
            let {
                crossOrigin: p,
                ignoreErrors: m,
                allowSoundInterruptions: f,
                baseURL: o,
              } = e,
              n = c(r);
            r = b(r, o);
            let u = new Audio(),
              s = { asset: u, type: "sound", src: r, id: n };
            return new Promise((d) => {
              l(t, 1),
                (u.crossOrigin = p),
                (u.onerror = (w) => {
                  if ((console.error(w), !m))
                    throw new Error("Failed to load " + r);
          ...
          loadJSON: async (r, a, p) => {
            ...
            return (
              u
                ...
                .catch((s) => {
                  if ((console.error(s), !f))
                    throw new Error("Failed to load JSON from " + r);
  ...
  (() => {
    ...
    var _ = (a, c, m, l, s, h, f, b) => (
      o(isFinite(a), "colrect: 1st param must be a number"),
      o(isFinite(c), "colrect: 2nd param must be a number"),
      o(isFinite(m), "colrect: 3rd param must be a number"),
      o(isFinite(l), "colrect: 4th param must be a number"),
      o(isFinite(s), "colrect: 5th param must be a number"),
      o(isFinite(h), "colrect: 6th param must be a number"),
      o(isFinite(f), "colrect: 7th param must be a number"),
      o(isFinite(b), "colrect: 8th param must be a number"),
      a < s + f && a + m > s && c < h + b && c + l > h
    );
    var x = (a, c, m, l, s, h) => (
      o(isFinite(a), "colcirc: 1st param must be a number"),
      o(isFinite(c), "colcirc: 2nd param must be a number"),
      o(isFinite(m), "colcirc: 3rd param must be a number"),
      o(isFinite(l), "colcirc: 4th param must be a number"),
      o(isFinite(s), "colcirc: 5th param must be a number"),
      o(isFinite(h), "colcirc: 6th param must be a number"),
      (l - a) * (l - a) + (s - c) * (s - c) <= (m + h) * (m + h)
    );
    var wt = 2 * Math.PI;
    var oe = Math.PI / 2;
    var Z = { warnings: true };
    function v(a, c = {}) {
      if (((c = Object.assign({}, Z, c)), a.stat(1)))
        throw 'Plugin Migrate should be loaded before the "init" event';
      let l = a.stat(0);
      function s(t, e, r = "") {
        c.warnings &&
          console.warn(
            `[litecanvas/migrate] ${t} is removed. ` +
              (e ? `Use ${e} instead. ` : "") +
              r
          );
      }
      ...
      function M(t, e) {
        ...
        return (
          (d.height = d.actualBoundingBoxAscent + d.actualBoundingBoxDescent), d
        );
      }
      function I(t, e, r, i) {
        s("cliprect()", "clip()");
      ...
      function C(t, e, r, i, p, d, D = true) {
        return (
          s("transform()", "ctx().setTransform() or ctx().transform()"),
          a.ctx()[D ? "setTransform" : "transform"](t, e, r, i, p, d)
        );
      }
      function S() {
      ...
      function N(t, e) {
        ...
        s("resize()", null, "Avoid changing the canvas dimensions at runtime."),
          (a.CANVAS.width = t),
          u("W", t),
          u("CX", t / 2),
          (a.CANVAS.height = e),
      ...
      for (let t of ["W", "H", "T", "CX", "CY", "MX", "MY"])
        a[t] != null && u(t, a[t]);
      if (
        (s(
          "FPS",
      ...
      function B(t) {
        s(
          ...
          t instanceof Path2D ? a.ctx().clip(t) : W(t);
      }
      return (
        l.antialias && s('"antialias" option', '"pixelart" option'),
        {
          def: u,
          seed: h,
          print: E,
  ...
  (() => {
    function A(s = {}) {
      let n = 0,
        ...
        i = [],
        p = () => (performance || Date).now();
      ["right", "left"].includes(b) || (b = "right"),
        (r.style.cssText = `position:absolute;top:0;${b}:0;cursor:pointer;opacity:0.8;z-index:10000`),
        r.addEventListener(
          "click",
          function (a) {
      ...
      function e(a) {
        for (let t = 0; t < r.children.length; t++)
          r.children[t].style.display = t === a ? "block" : "none";
        n = a;
      }
      function v() {
        ...
        e(0),
        {
          ...
          begin: function () {
            ...
            if (
              (w.update(a - m, 200),
              a >= u + 1e3 &&
                (y.update((l * 1e3) / (a - u), 100), (u = a), (l = 0), c))
            ) {
    ...
    function S(s, n, o, b, r = {}) {
      ...
      (c.width = v * e),
        (c.height = h * e),
        (c.style.cssText = `width:${v}px;height:48px;`);
      let a = b.children.length;
      b.appendChild(c);
      let t = c.getContext("2d");
      (t.font = `bold ${9 * e}px Helvetica,Arial,sans-serif`),
        (t.textBaseline = "top");
      function x() {
        (t.fillStyle = o),
          t.fillRect(0, 0, v * e, h * e),
          (t.fillStyle = n),
          t.fillText(s, d, m),
          t.fillRect(u, l, y, w),
          (t.fillStyle = o),
        ...
        x(),
        {
          ...
          update: function (g, _) {
            (p = Math.min(p, g)),
              ...
              (t.fillStyle = o),
              (t.globalAlpha = 1),
              t.fillRect(0, 0, v * e, l),
              (t.fillStyle = n);
            let T = [i(g), s];
            r.labelBefore && T.reverse(),
              t.fillText(T.join(" ") + " (" + i(p) + "-" + i(f) + ")", d, m),
              t.drawImage(c, u + e, l, y - e, w, u, l, y - e, w),
              t.fillRect(u + y - e, l, e, w),
              (t.fillStyle = o),
              (t.globalAlpha = 0.9),
              t.fillRect(u + y - e, l, e, i((1 - g / _) * w));
          },
        }
      );
    }
    ...
    function E(s, n = {}) {
      ...
      return (
        s.canvas().parentElement.appendChild(e.dom),
        h(!n.hidden),
        f.keyboardEvents &&
          s.listen("update", () => {
            b && s.iskeypressed(b) && h(n.hidden),
              o && s.iskeypressed(o) && e.nextPanel();
          }),
  ...
  (() => {
    var F = [
        [24, 60, 60, 24, 24, , 24],
        [54, 54, , , , , ,],
        [54, 54, 127, 54, 127, 54, 54],
        [12, 62, 3, 30, 48, 31, 12],
        [, 99, 51, 24, 12, 102, 99],
        [28, 54, 28, 110, 59, 51, 110],
        [6, 6, 3, , , , ,],
        [24, 12, 6, 6, 6, 12, 24],
        [6, 12, 24, 24, 24, 12, 6],
        [, 102, 60, 255, 60, 102, ,],
        ...
        [, , , , , 12, 12],
        [96, 48, 24, 12, 6, 3, 1],
        [62, 99, 115, 123, 111, 103, 62],
        [12, 14, 12, 12, 12, 12, 63],
        [30, 51, 48, 28, 6, 51, 63],
        [30, 51, 48, 28, 48, 51, 30],
        [56, 60, 54, 51, 127, 48, 120],
        [63, 3, 31, 48, 48, 51, 30],
        [28, 6, 3, 31, 51, 51, 30],
        [63, 51, 48, 24, 12, 12, 12],
        [30, 51, 51, 30, 51, 51, 30],
        [30, 51, 51, 62, 48, 24, 14],
        [, 12, 12, , , 12, 12],
        [, 12, 12, , , 12, 12, 6],
        [24, 12, 6, 3, 6, 12, 24],
        [, , 63, , , 63, ,],
        [6, 12, 24, 48, 24, 12, 6],
        [30, 51, 48, 24, 12, , 12],
        [62, 99, 123, 123, 123, 3, 30],
        [12, 30, 51, 51, 63, 51, 51],
        [63, 102, 102, 62, 102, 102, 63],
        [60, 102, 3, 3, 3, 102, 60],
        [31, 54, 102, 102, 102, 54, 31],
        [127, 70, 22, 30, 22, 70, 127],
        [127, 70, 22, 30, 22, 6, 15],
        [60, 102, 3, 3, 115, 102, 124],
        [51, 51, 51, 63, 51, 51, 51],
        [30, 12, 12, 12, 12, 12, 30],
        [120, 48, 48, 48, 51, 51, 30],
        [103, 102, 54, 30, 54, 102, 103],
        [15, 6, 6, 6, 70, 102, 127],
        [99, 119, 127, 127, 107, 99, 99],
        [99, 103, 111, 123, 115, 99, 99],
        [28, 54, 99, 99, 99, 54, 28],
        [63, 102, 102, 62, 6, 6, 15],
        [30, 51, 51, 51, 59, 30, 56],
        [63, 102, 102, 62, 54, 102, 103],
        [30, 51, 7, 14, 56, 51, 30],
        [63, 45, 12, 12, 12, 12, 30],
        [51, 51, 51, 51, 51, 51, 63],
        [51, 51, 51, 51, 51, 30, 12],
        [99, 99, 99, 107, 127, 119, 99],
        [99, 99, 54, 28, 28, 54, 99],
        [51, 51, 51, 30, 12, 12, 30],
        [127, 99, 49, 24, 76, 102, 127],
        [30, 6, 6, 6, 6, 6, 30],
        [3, 6, 12, 24, 48, 96, 64],
        ...
        [7, 6, 6, 62, 102, 102, 59],
        [, , 30, 51, 3, 51, 30],
        [56, 48, 48, 62, 51, 51, 110],
        [, , 30, 51, 63, 3, 30],
        [28, 54, 6, 15, 6, 6, 15],
        [, , 110, 51, 51, 62, 48, 31],
        [7, 6, 54, 110, 102, 102, 103],
        [12, , 14, 12, 12, 12, 30],
        [48, , 48, 48, 48, 51, 51, 30],
        [7, 6, 102, 54, 30, 54, 103],
      ...
      g = { id: "basic", chars: F, first: 33, w: 8, h: 8 };
    var I = [
        [2, 2, 2, , 2],
        [5, 5],
        [5, 7, 5, 7, 5],
      ...
      y = { id: "mini", chars: I, first: 33, w: 4, h: 6 };
